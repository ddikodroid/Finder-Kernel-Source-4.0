...
#define MSM_CAM_IOCTL_SENSOE_RESET \
	_IO(MSM_CAM_IOCTL_MAGIC, 53)
/*end*/
#define MSM_CAM_IOCTL_GET_MODULE_TYPE \
	_IO(MSM_CAM_IOCTL_MAGIC, 54)
...
/* SONY , LITEON */
#define CAMERA_MODULE_SONY   0
#define CAMERA_MODULE_LITEON 1
...
/* OPPO 2011-01-06 tanrf Modify begin for : support CAF state reporting */
#if 0
#define MSM_CAMERA_ERR_MASK (0xFFFFFFFF & 1)
#else
#define MSM_CAMERA_ERR_MASK (0xFFFFFFFF & 0xC0000001)
#endif
/* OPPO 2011-01-06 tanrf Modify end */
...
/* Added yxq 2012-04-16 start */
#define SENSOR_PREVIEW_S_MODE 6
/* Added yxq 2012-04-16 end */
...
#define SENSOR_FULL_SIZE		1
#define SENSOR_QVGA_SIZE		2
#define SENSOR_720P_SIZE		3
#define SENSOR_1080P_SIZE		4
#define SENSOR_INVALID_SIZE		5
