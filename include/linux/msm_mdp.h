...
//after 200, used to define oppo ioctls,add by wangcy
#define OPPO_CHANGE_LCD_PCLK _IOW(MSMFB_IOCTL_MAGIC, 200, unsigned int)
#define OPPO_GET_LCD_PCLK _IOW(MSMFB_IOCTL_MAGIC, 201, unsigned int)
#define OPPO_STATIC_ELECTRICITY _IOW(MSMFB_IOCTL_MAGIC, 202, unsigned int)
#define OPPO_SETUP_ACL_SAVE _IOW(MSMFB_IOCTL_MAGIC, 203, unsigned int)
#define OPPO_GET_ACL_STATE _IOW(MSMFB_IOCTL_MAGIC, 204, unsigned int)
...
//added by zhengzk on 2012-05-18 for improve display effect on TV
