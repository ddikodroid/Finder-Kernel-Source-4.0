...
#endif
//default value is 7 and the current is 4.6mA,  4/2.6mA  5/3.3mA  6/3.9mA 8/5.2mA
...
//value = current mA/2
static void led_lc_set_current(struct pmic8058_led_data *led, int mA)
{
	unsigned long flags;
	int rc, offset;
	u8 level, tmp;
