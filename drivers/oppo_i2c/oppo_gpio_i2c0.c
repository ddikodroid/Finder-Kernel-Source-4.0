...
/*define sda and scl*/
#define PM8058_GPIO14	13//PMIC8058 GPIO number 14
#define PM8058_GPIO31	30//PM8058_GPIO_PM_TO_SYS(30)	
#define GPIO_I2C_SCL	PM8058_GPIO_PM_TO_SYS(PM8058_GPIO31)
#define GPIO_I2C_SDA	PM8058_GPIO_PM_TO_SYS(PM8058_GPIO14)
...
#define READ_SIF_SDA  	gpio_get_value_cansleep(GPIO_I2C_SDA)
#define CLR_SIF_SDA  	gpio_set_value_cansleep(GPIO_I2C_SDA, 0)
#define SET_SIF_SDA     gpio_set_value_cansleep(GPIO_I2C_SDA, 1)

#define READ_SIF_SCL  	gpio_get_value_cansleep(GPIO_I2C_SCL)
#define CLR_SIF_SCL     gpio_set_value_cansleep(GPIO_I2C_SCL, 0)
#define SET_SIF_SCL     gpio_set_value_cansleep(GPIO_I2C_SCL, 1)
...
/*
 * Function : BOOL gpio_i2c0_readData(BYTE bDevice, BYTE bData_Addr,
 ...
 *        FALSE  : bus (SCL = 0) or ACK failure
*/
BOOL gpio_i2c0_readData(BYTE bDevice, UINT16 u2Data_Addr, BYTE bDataCount,BYTE *prData) 
{
...
/*
 * Function : BOOL gpio_i2c0_writeData(BYTE bDevice, BYTE bData_Addr,
 *                                   BYTE bDataCount, BYTE *prData)
...
BOOL gpio_i2c0_writeData(BYTE bDevice, UINT16 u2Data_Addr,BYTE bDataCount, BYTE *prData)
{
    BYTE bOrg_device;
 ...
 *
 */
static int __init gpio_i2c0_init(void)
{
	if (gpio_i2c_initialized == 0)
	{
		...
		/*config pm8058_gpio*/
		pmic8058_i2c_gpio_config(PM8058_GPIO_PM_TO_SYS(PM8058_GPIO14),1);
		pmic8058_i2c_gpio_config(PM8058_GPIO_PM_TO_SYS(PM8058_GPIO31),1);

		return 0;
	} 
	else
	{
		pr_err("%s: gpio_i2c0 initialize fail\n", __func__);
		return 1;
	}
	
}

static void __exit gpio_i2c0_exit(void)
{
    gpio_i2c_initialized = 0;
}

module_init(gpio_i2c0_init);
module_exit(gpio_i2c0_exit);
...
EXPORT_SYMBOL(gpio_i2c0_readData);
EXPORT_SYMBOL(gpio_i2c0_writeData);
