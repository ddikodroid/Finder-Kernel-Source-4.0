...
//added by zhangyue for adding the ability of disable hdcp, you can search this marcro to know all the code added
#define zy_hdcp_ctrl 1
#endif
#ifdef CONFIG_OPPO_MODIFY
//added by zhangyue for adding the ability of disable hdcp, you can search this marcro to know all the code added
