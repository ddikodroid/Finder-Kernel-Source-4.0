...
//porting form 10089 project by chendx 2011-09-01
/* OPPO 2011-01-14 wangjc Add begin for PHY regs */
/* Read only bit */
#define PHY_CHGDET_MASK_VOUT          (0x1 << 4) /* 0-Host(def), 1-Charger    */

/* Writable bits */
#define PHY_CHGDET_MASK_WRITE         (0xF)      /* Writable bit mask         */
#define PHY_CHGDET_MASK_EXTCHGRCTRL   (0x1 << 3) /* 0-Ext, 1-ULPI(def)        */
#define PHY_CHGDET_MASK_CHGRMODE      (0x1 << 2) /* 0-Host, 1-Device(def)     */
#define PHY_CHGDET_MASK_CHGRDETON_M   (0x1 << 1) /* 0-On, 1-Off(def)          */
#define PHY_CHGDET_MASK_CHGRDETEN_M   (0x1)      /* 0-Enable, 1-Disable(def)  */

#define ULPI_FNCTL			0x04
#define PHY_FNCTL_MASK_MODE           (0x3 << 3) /* Clears bit 3 and 4 */
#define PHY_FNCTL_MASK_MODE_NON_DRIVE (0x1 << 3)
