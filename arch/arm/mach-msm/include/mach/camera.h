...
struct msm_sensor_ctrl {
	...
	int (*s_get_module_type)(void __user *);
...
struct msm_control_device {
	...
	struct mutex control_lock; /*2011-3-29 sunjianbo add*/
};
...
void msm_camera_vreg_ctl(int ,int);/*OPPO sunjianbo 2011-12-28 ESD*/
void msm_camio_camif_pad_reset_csi(int restore);/*OPPO sunjianbo 2012-2-1 ESD*/
