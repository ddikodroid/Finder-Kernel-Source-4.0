...
#ifdef CONFIG_OPPO_MODIFY
//modified by zhangyue on 2011-11-05 for debuggint the gpio 40
//the gpio 40 can't set value in suspending process
...
#endif
#ifdef CONFIG_OPPO_MODIFY
//added by zhangyue on 2011-11-10 for debugging 
// mhl int is gpio 124
static struct gpiomux_setting mhl_int_cfg ={
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};

//added by tanglc on 2011-11-17 for gpio 74/76/81/84 setting
static struct gpiomux_setting s3a_init_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
...
/* Modified by yxq 2012-04-15 start */
...
#endif
/* Modified by yxq 2012-04-15 end */
...
/* Added by yxq 2012-04-15 start */
#ifdef CONFIG_OPPO_MODIFY
static struct gpiomux_setting gpio125_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
static struct gpiomux_setting gpio125_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
};
#endif
/* Added by yxq 2012-04-15 end */
...
#ifdef CONFIG_OPPO_MODIFY
//added by zhangyue on 2011-11-05 for debugging.
//the problem is we can't set value for gpio_40 in suspend function
static struct msm_gpiomux_config msm8x60_mhl_configs[] __initdata = {
	...
	},
	{
		.gpio = 124,
		.settings = {
			[GPIOMUX_ACTIVE] = &mhl_int_cfg,
			[GPIOMUX_SUSPENDED] = &mhl_int_cfg,
		}	
	}
};

static struct msm_gpiomux_config msm8x60_s3a_configs[] __initdata = {
	{
		.gpio = 81,
		.settings = {
			[GPIOMUX_ACTIVE] = &s3a_init_cfg,
			[GPIOMUX_SUSPENDED] = &s3a_init_cfg,
		},
	},
	{
		.gpio = 84,
...
static struct msm_gpiomux_config msm8x60_ebi2_configs[] __initdata = {
	#ifdef CONFIG_OPPO_MODIFY
	//deleted by zhangyue on 2011-11-05 for debuggint the gpio 40
	//the gpio 40 can't set value in suspending process
	#else
	{
		.gpio      = 40,
	...
	#ifndef CONFIG_OPPO_MODIFY
	//deleted by zhangyue on 2011-11-10 for debugging
	{
		.gpio      = 124,
		.settings = {
			[GPIOMUX_SUSPENDED] = &ebi2_a_d,
...
#else
{
		.gpio	   = 125,
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio125_active_cfg,
			[GPIOMUX_SUSPENDED] = &gpio125_suspend_cfg,
	},
},
#endif
/* Modified by yxq 2012-04-15 end */
...
/* Added by yxq 2012-04-15 start */
#ifdef CONFIG_OPPO_MODIFY
	/* 45 and 72 are used by subcamera, 45 for pwd, 72 for reset */
	{
		.gpio = 45,
		.settings = {
			[GPIOMUX_ACTIVE]	= &cam_active_4_cfg,
...
#ifdef CONFIG_OPPO_MODIFY
//added by zhanyue on 11-05 for debugging, to config the gpio_40 for mhl
	{msm8x60_mhl_configs, ARRAY_SIZE(msm8x60_mhl_configs)},
	{msm8x60_s3a_configs, ARRAY_SIZE(msm8x60_s3a_configs)},
#endif
