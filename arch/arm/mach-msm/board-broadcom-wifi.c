...
#define WLAN_OOB_IRQ  57 //wlan_wake_host , the GPIO number of qualcomm platform, modified
...
static struct resource brcm_wifi_resources[] = {
	[0] = {
		...
		.start		= MSM_GPIO_TO_INT(WLAN_OOB_IRQ),
		.end		= MSM_GPIO_TO_INT(WLAN_OOB_IRQ),
